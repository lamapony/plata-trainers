...
5. Optional account vault
   ...
   Only after the local model is useful: add optional account sync for memory facts. The account should synchronize a compact, auditable learner profile across devices.
