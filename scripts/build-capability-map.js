...
const capabilitySpecs = [
  ...
  },
  {
    ...
    surfaces: ["reports/capabilities.json", "reports/project-health.json", "Pull-request QA review report", "README"],
    proofGates: ["check:capability-map", "check:health", "check:pages", "check:quality-report", "check:today-program-report", "check:review-report"],
    publicReports: ["capabilities", "project-health", "quality", "skill-coverage", "today-program"],
    docs: ["README.md", "docs/DEVELOPMENT_JOURNAL.md"],
    sourcePaths: ["scripts/build-capability-map.js", "scripts/build-project-health-manifest.js", "scripts/build-review-report.js", "scripts/build-pages-artifact.js", ".github/workflows/qa.yml"],
    contracts: [
