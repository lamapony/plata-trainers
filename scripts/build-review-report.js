...
function usage() {
  return "usage: node scripts/build-review-report.js --quality-diff <quality.json> --dashboard-diff <dashboard.json> --trajectory-diff <trajectory.json> [--json] [--fail-on-change] [--fail-on-regression]";
}
